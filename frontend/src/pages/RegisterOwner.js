...
import { registerOwner } from "../libs/api";
...
const RegisterOwner = () => {
    ...
    const onSubmit = (data) => {
        mutation.mutate({ ...data, role: "Owner" });
    };
                ...
                <div className="col-md-6 col-lg-5">
                    <div className="card shadow-lg border-0 rounded-4">
                        <div className="card-body p-5">
                            <h2 className="text-center mb-4 fw-bold text-primary">Owner Sign Up</h2>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                >
                                    {mutation.isLoading ? "Creating Account..." : "Create Owner Account"}
                                </button>
                            </form>
                            <div className="text-center mt-4">
                                ...
                                <p className="text-muted small">
                                    Looking for a place? <Link to="/register/customer">Register as Customer</Link>
                                </p>
                            </div>
                        </div>
                    </div>
